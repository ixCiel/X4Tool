...
namespace X4Tool
{
    ...
    public delegate void ConsoleOut(string text, int progress);
    public delegate string _GetXmlValueText(string path, string key);
    public delegate void _SetXmlValueText(string path, string key,string value);
    public delegate string _XmlValueChecked(string value,out bool canSet);
    public delegate string _XmlValueChanged(string value);

    public delegate void _SetText(string value);
